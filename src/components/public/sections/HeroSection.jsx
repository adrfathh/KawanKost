        ...
        <div className="flex flex-col lg:flex-row items-center justify-between">
          <div className={styles.heroContent}>
            ...
            <div className="flex flex-col sm:flex-row gap-4">
              <button className={`${styles.button} flex items-center justify-center`}><Search className="mr-2" size={20} />Cari Kost Sekarang</button>
              <button className={`${styles.button} ${styles.buttonOutline} flex items-center justify-center`}><Users className="mr-2" size={20} />Konsultasi Gratis</button>
            </div>
          </div>
